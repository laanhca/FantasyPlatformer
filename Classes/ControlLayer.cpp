...
void ControlLayer::addBtn() {
    ...
    mLeftBtn->setPosition(Vec2(Director::getInstance()->getWinSize().width-Director::getInstance()->getVisibleSize().width,Director::getInstance()->getWinSize().height-Director::getInstance()->getVisibleSize().height));
    mLeftBtn->setScale(2);
    ...
    mRightBtn->setPosition(Vec2(Director::getInstance()->getWinSize().width-Director::getInstance()->getVisibleSize().width+mLeftBtn->getContentSize().width*mLeftBtn->getScaleX()+mLeftBtn->getContentSize().width,Director::getInstance()->getWinSize().height-Director::getInstance()->getVisibleSize().height));
    ...
    mJumpBtn->setPosition(Vec2(Director::getInstance()->getWinSize().width-Director::getInstance()->getVisibleSize().width+mLeftBtn->getContentSize().width*mLeftBtn->getScaleX()+mLeftBtn->getContentSize().width*mLeftBtn->getScaleX()/2+mLeftBtn->getContentSize().width/2,Director::getInstance()->getWinSize().height-Director::getInstance()->getVisibleSize().height+mLeftBtn->getContentSize().height*mLeftBtn->getScaleY()));
    mJumpBtn->setScale(2);
    ...
    mAttackBtn->setPosition(Vec2(Director::getInstance()->getWinSize().width-mAttackBtn->getContentSize().width,Director::getInstance()->getWinSize().height-Director::getInstance()->getVisibleSize().height));
    ...
    avatarFrame->setPosition(Vec2(Director::getInstance()->getWinSize().width-Director::getInstance()->getVisibleSize().width,Director::getInstance()->getWinSize().height-Director::getInstance()->getVisibleOrigin().y));
    ...
    avatarImg->setPosition(Vec2(Director::getInstance()->getWinSize().width-Director::getInstance()->getVisibleSize().width+5,Director::getInstance()->getWinSize().height-Director::getInstance()->getVisibleOrigin().y-5));
    ...
    hpBoder->setScale(4);
    hpBoder->setPosition(avatarFrame->getPositionX()+avatarFrame->getContentSize().width*avatarFrame->getScaleX(),Director::getInstance()->getWinSize().height-Director::getInstance()->getVisibleOrigin().y- hpBoder->getContentSize().height);
    ...
    mpBoder->setPosition(hpBoder->getPositionX(),hpBoder->getPositionY()-hpBoder->getContentSize().height*hpBoder->getScale());
...
//            mPlayer->getPhysicsBody()->applyImpulse(Vec2(0,100000));
            ...
            if(mPlayer->mTouchFloor){
                ...
                mPlayer->getPhysicsBody()->applyImpulse(cocos2d::Vec2(0.0f, mPlayer->getJumpForce()));
...
void ControlLayer::setTimer() {
    ...
    timerIcon->setPosition(Vec2(Director::getInstance()->getWinSize().width-Director::getInstance()->getVisibleSize().width/2,Director::getInstance()->getWinSize().height-Director::getInstance()->getVisibleOrigin().y- timerIcon->getContentSize().height*2));
...
void ControlLayer::setScore() {
    ...
    scoreIcon->setPosition(Vec2(Director::getInstance()->getWinSize().width- Director::getInstance()->getVisibleSize().width/4,Director::getInstance()->getWinSize().height-Director::getInstance()->getVisibleOrigin().y- scoreIcon->getContentSize().height*2));
