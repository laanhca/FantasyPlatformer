...
//    auto border = Sprite::create("gui/PNG/06Level_select/level_select_full_window.png");
    auto border = Sprite::create("gui/PNG/06Level_select/levelselectbg.png");
    ...
    this->addChild(border);
     ...
     item1 = MenuItemImage::create("gui/PNG/06Level_select/done_not_chosen.png",
    ...
    item1->setTag(1);
    item1->setScale(3);
     item2 = MenuItemImage::create("gui/PNG/06Level_select/done_not_chosen.png",
                                       "gui/PNG/06Level_select/door.png",
                                       "gui/PNG/06Level_select/full_door_blocked.png",
                                       CC_CALLBACK_1(LevelSelect::onClickDoor, this));
    ...
    item2->setTag(2);
    item2->setScale(3);
     item3 = MenuItemImage::create("gui/PNG/06Level_select/done_not_chosen.png",
                                       "gui/PNG/06Level_select/door.png",
                                       "gui/PNG/06Level_select/full_door_blocked.png",
                                       CC_CALLBACK_1(LevelSelect::onClickDoor, this));
...
//    this->addChild(title);
    ...
    checkCurrentLv();
    //mUserDefault->setBoolForKey("lock2", true);
    lock2 = mUserDefault->getBoolForKey("lock2", true);
     //mUserDefault->setBoolForKey("lock3", true);
    lock3 = mUserDefault->getBoolForKey("lock3", true);
...
void LevelSelect::checkCurrentLv(){
    if(GameConst::GameData::currentLevel ==2){
        mUserDefault->setBoolForKey("lock2", false);
        mUserDefault->flush();
    }
    if(GameConst::GameData::currentLevel ==3){
        mUserDefault->setBoolForKey("lock3", false);
        mUserDefault->flush();
    }
}