...
//    characters->setScale(2);
    characters->setScale((visiableSize.width / 2) / characters->getContentSize().width,
                       (visiableSize.height / 2) / characters->getContentSize().height);
...
//    title->setScale(1.5);
    ...
    mSettingBtn->setPosition(Vec2(visiableSize.width / 2, mPlayBtn->getPositionY() -
                                                          mPlayBtn->getContentSize().height *
                                                          mPlayBtn->getScaleY()));
    mSettingBtn->setScale(Director::getInstance()->getVisibleSize().width / 4 / mSettingBtn->getContentSize().width,
                          Director::getInstance()->getVisibleSize().height / 9 / mSettingBtn->getContentSize().height);
    ...
    mExitBtn->setPosition(Vec2(visiableSize.width / 2, mSettingBtn->getPositionY() -
                                                       mPlayBtn->getContentSize().height *
                                                       mPlayBtn->getScaleY()));
    mExitBtn->setScale(Director::getInstance()->getVisibleSize().width / 4 / mExitBtn->getContentSize().width,
                       Director::getInstance()->getVisibleSize().height / 9 / mExitBtn->getContentSize().height);
