...
bool MainMenu::init(){
    ...
    bg->setScale(visiableSize.width/bg->getContentSize().width,(visiableSize.height+origin.y)/bg->getContentSize().height);
    this->addChild(bg,-2);
    ...
    platform->setScale((visiableSize.width/2)/platform->getContentSize().width,(visiableSize.height/4)/platform->getContentSize().height);
    ...
    characters->setPosition(visiableSize.width/2,visiableSize.height/2+origin.y+(platform->getContentSize().height*platform->getScaleY())/2);
...
//    title->setContentSize(platform->getContentSize()*platform->getScale());
    ...
    this->addChild(title);
     ...
     mPlayBtn = cocos2d::ui::Button::create("gui/PNG/01main/buttons1.png","gui/PNG/01main/buttons1_yellow.png");
     mPlayBtn->setPosition(Vec2(visiableSize.width/2,visiableSize.height/2+origin.y-(platform->getContentSize().height*platform->getScaleY())/2-mPlayBtn->getContentSize().height));
     mPlayBtn->setScale(visiableSize.width/4/mPlayBtn->getContentSize().width,visiableSize.height/9/mPlayBtn->getContentSize().height);
    ...
    mSettingBtn = cocos2d::ui::Button::create("gui/PNG/01main/buttons1.png","gui/PNG/01main/buttons1_yellow.png");
    mSettingBtn->setPosition(Vec2(visiableSize.width/2,mPlayBtn->getPositionY()-mPlayBtn->getContentSize().height*mPlayBtn->getScaleY()));
    ...
    mExitBtn = cocos2d::ui::Button::create("gui/PNG/01main/buttons1.png","gui/PNG/01main/buttons1_yellow.png");
    mExitBtn->setPosition(Vec2(visiableSize.width/2,mSettingBtn->getPositionY()-mPlayBtn->getContentSize().height*mPlayBtn->getScaleY()));
