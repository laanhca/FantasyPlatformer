...
bool  LevelSelect::init() {
    ...
    border->setScale(visiableSize.width*0.8f/border->getContentSize().width,visiableSize.height*0.8f/border->getContentSize().height);
    this->addChild(border);


    auto item1= MenuItemImage::create("gui/PNG/06Level_select/done_not_chosen.png","gui/PNG/06Level_select/door.png",
            "gui/PNG/06Level_select/full_door_blocked.png",CC_CALLBACK_1(LevelSelect::onClickDoor,this));
    item1->setPosition(150,150);
    item1->setTag(1);
    item1->setScale(3);
    auto item2= MenuItemImage::create("gui/PNG/06Level_select/done_not_chosen.png","gui/PNG/06Level_select/door.png",
                                      "gui/PNG/06Level_select/full_door_blocked.png",CC_CALLBACK_1(LevelSelect::onClickDoor,this));
    item2->setPosition(250,150);
    item2->setTag(2);
    item2->setScale(3);
    auto item3= MenuItemImage::create("gui/PNG/06Level_select/done_not_chosen.png","gui/PNG/06Level_select/door.png",
                                      "gui/PNG/06Level_select/full_door_blocked.png",CC_CALLBACK_1(LevelSelect::onClickDoor,this));
    ...
    title->setScale(3);
    this->addChild(title);
    auto xButton = MenuItemImage::create("gui/PNG/06Level_select/x_button.png","gui/PNG/06Level_select/x_button.png", CC_CALLBACK_1(LevelSelect::onClickBack,this));
    xButton->setScale(3);
