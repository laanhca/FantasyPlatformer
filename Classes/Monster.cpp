...
void Monster::createBody(std::string path) {
    ...
    auto physicBodyMonster= PhysicsBody::createBox(Size(25,25),cocos2d::PhysicsMaterial(0.5f, 0.0f, 0.5f));
...
bool Monster::onPhysicContactBegin(PhysicsContact &contact) {
    ...
    if((shapeA==GameConst::TAG_MONSTER && shapeB==GameConst::TAG_PLAYER)||(shapeA==GameConst::TAG_PLAYER && shapeB==GameConst::TAG_MONSTER)){
//        this->setState(GameConst::ATTACK_STATE);
